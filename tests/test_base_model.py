...
class TestBaseModel(unittest.TestCase):
    ...
    def testattr(self):
        ...
        self.assertFalse(hasattr(self.basemodel, "name"))
        self.assertEqual(self.basemodel.__class__.name__, "BaseMode")

        def test_to_dict(self):
            """Test conversion of object attributes to dictionary fot json"""
            my_model = BaseModel()
            ...
            expected_attrs = ["id",
                              ...
                              "my_number",
                              "__class__"]
            self.assertCountEqual(d.key(), expected_attrs)
